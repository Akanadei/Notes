...
button_note_create = QPushButton('Создать заметку') # появляется поле с 'Введите имя заметки
...
#расположение виджетов по лэйаутом
...
'''Функцинал приложения'''
'''РАБОТА С ТЕКТСОМ ЗАМЕТКИ'''
...
def save_note():
    if list_notes.selectedItems():
        ...
        print("Заметка для сохранения выбрана")
...
def del_note():
    if list_notes.selectedItems():
        ...
        print("Замектка для удаления выбрана")
